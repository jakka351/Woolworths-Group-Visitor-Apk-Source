...
public class ViewShot implements UIBlock {
    ...
    public void saveToRawFileOnDevice(View view) throws IOException {
        ...
        fileOutputStream.write(String.format(Locale.US, "%d:%d|", Integer.valueOf(pointCaptureView.x), Integer.valueOf(pointCaptureView.y)).getBytes(Charset.forName(CharEncoding.US_ASCII)));
                        ...
                        try {
                            PixelCopy.request(surfaceView, exactBitmapForScreenshot, new PixelCopy.OnPixelCopyFinishedListener() { // from class: fr.greweb.reactnativeviewshot.ViewShot.2
                                ...
                                public void onPixelCopyFinished(int i5) {
                                    int iSave2 = canvas3.save();
                                    ViewShot.this.applyTransformations(canvas3, view, view3);
                                    canvas3.drawBitmap(exactBitmapForScreenshot, 0.0f, 0.0f, paint2);
                                    canvas3.restoreToCount(iSave2);
