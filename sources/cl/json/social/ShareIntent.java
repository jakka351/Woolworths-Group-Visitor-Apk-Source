...
public abstract class ShareIntent {
    ...
    public void open(ReadableMap readableMap) throws ActivityNotFoundException {
        ...
        if (hasValidKey(KeychainModule.AuthPromptOptions.TITLE, readableMap)) {
            this.chooserTitle = readableMap.getString(KeychainModule.AuthPromptOptions.TITLE);
        }
    ...
    protected void openIntentChooser() throws ActivityNotFoundException {
        ...
        intentCreateChooser.addFlags(BasicMeasure.EXACTLY);
