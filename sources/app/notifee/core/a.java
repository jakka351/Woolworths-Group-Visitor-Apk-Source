...
public class a {
    ...
    public static Task<Void> a(final n.o.t.i.f.e.e.c cVar) {
        return Tasks.call(a, new Callable() { // from class: app.notifee.core.a$$ExternalSyntheticLambda2
    ...
    public static Task<Void> a(final n.o.t.i.f.e.e.b bVar) {
        return Tasks.call(a, new Callable() { // from class: app.notifee.core.a$$ExternalSyntheticLambda0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return a.b(bVar);
            }
    ...
    public static Task<Void> a(final List<n.o.t.i.f.e.e.b> list) {
        return Tasks.call(a, new Callable() { // from class: app.notifee.core.a$$ExternalSyntheticLambda4
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return a.c(list);
            }
    ...
    public static Task<Bundle> a(final String str) {
        return Tasks.call(a, new Callable() { // from class: app.notifee.core.a$$ExternalSyntheticLambda8
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return a.e(str);
            }
    ...
    public static Task<List<Bundle>> a() {
        return Tasks.call(a, new Callable() { // from class: app.notifee.core.a$$ExternalSyntheticLambda5
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return a.c();
            }
    ...
    public static Void b(n.o.t.i.f.e.e.c cVar) throws Exception {
        Integer numValueOf;
        long[] jArr;
        String str = (String) Objects.requireNonNull(cVar.a.getString("id"));
        String str2 = (String) Objects.requireNonNull(cVar.a.getString("name"));
        if (cVar.a.containsKey("importance")) {
            numValueOf = Integer.valueOf(l.a(cVar.a.get("importance")));
        } else {
            numValueOf = 3;
        }
    ...
    public static Task<Boolean> d(final String str) {
        return Tasks.call(a, new Callable() { // from class: app.notifee.core.a$$ExternalSyntheticLambda6
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return a.h(str);
            }
    ...
    public static Task<Boolean> c(final String str) {
        return Tasks.call(a, new Callable() { // from class: app.notifee.core.a$$ExternalSyntheticLambda1
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return a.g(str);
            }
    ...
    public static Task<Void> b(final List<n.o.t.i.f.e.e.c> list) {
        return Tasks.call(a, new Callable() { // from class: app.notifee.core.a$$ExternalSyntheticLambda7
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return a.d(list);
            }
    ...
    public static Task<List<Bundle>> b() {
        return Tasks.call(a, new Callable() { // from class: app.notifee.core.a$$ExternalSyntheticLambda9
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return a.d();
            }
    ...
    public static Task<Bundle> b(final String str) {
        return Tasks.call(a, new Callable() { // from class: app.notifee.core.a$$ExternalSyntheticLambda3
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return a.f(str);
            }
