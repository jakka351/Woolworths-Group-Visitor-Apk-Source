...
public class Notifee {
    ...
    public void getInitialNotification(Activity activity, MethodCallResult<Bundle> methodCallResult) {
        ...
        if (gVar != null) {
            ...
            bundle.putBundle(LocationService.NOTIFICATION_CHANNEL, gVar.a.toBundle());
        ...
        if (activity != null) {
            try {
                ...
                if (intent != null && intent.getExtras() != null && intent.hasExtra(LocationService.NOTIFICATION_CHANNEL)) {
                    bundle.putBundle(LocationService.NOTIFICATION_CHANNEL, intent.getBundleExtra(LocationService.NOTIFICATION_CHANNEL));
                    methodCallResult.onComplete(null, bundle);
                    return;
                }
            } catch (Exception e) {
    ...
    public void getNotificationSettings(MethodCallResult<Bundle> methodCallResult) {
        boolean zAreNotificationsEnabled = NotificationManagerCompat.from(e.a).areNotificationsEnabled();
        Bundle bundle = new Bundle();
