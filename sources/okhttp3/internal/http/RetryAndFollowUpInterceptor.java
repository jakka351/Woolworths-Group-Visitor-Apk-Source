    ...
    */
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r11) throws java.io.IOException {
        ...
        L19:
            ...
            boolean r6 = r1.getCanceled()     // Catch: java.lang.Throwable -> Le3
            if (r6 != 0) goto Ldb
            okhttp3.Response r0 = r11.proceed(r0)     // Catch: java.io.IOException -> L99 okhttp3.internal.connection.RouteException -> Lb5 java.lang.Throwable -> Le3
            if (r7 == 0) goto L40
            okhttp3.Response$Builder r0 = r0.newBuilder()     // Catch: java.lang.Throwable -> Le3
            okhttp3.Response$Builder r6 = r7.newBuilder()     // Catch: java.lang.Throwable -> Le3
            okhttp3.Response$Builder r6 = r6.body(r4)     // Catch: java.lang.Throwable -> Le3
            okhttp3.Response r6 = r6.build()     // Catch: java.lang.Throwable -> Le3
            okhttp3.Response$Builder r0 = r0.priorResponse(r6)     // Catch: java.lang.Throwable -> Le3
            okhttp3.Response r0 = r0.build()     // Catch: java.lang.Throwable -> Le3
        L40:
            r7 = r0
            okhttp3.internal.connection.Exchange r0 = r1.getInterceptorScopedExchange()     // Catch: java.lang.Throwable -> Le3
            okhttp3.Request r6 = r10.followUpRequest(r7, r0)     // Catch: java.lang.Throwable -> Le3
            if (r6 != 0) goto L5a
            if (r0 == 0) goto L56
            boolean r11 = r0.getIsDuplex()     // Catch: java.lang.Throwable -> Le3
            if (r11 == 0) goto L56
            r1.timeoutEarlyExit()     // Catch: java.lang.Throwable -> Le3
        L56:
            r1.exitNetworkInterceptorExchange$okhttp(r3)
            return r7
        L5a:
            okhttp3.RequestBody r0 = r6.body()     // Catch: java.lang.Throwable -> Le3
            if (r0 == 0) goto L6a
            boolean r0 = r0.isOneShot()     // Catch: java.lang.Throwable -> Le3
            if (r0 == 0) goto L6a
            r1.exitNetworkInterceptorExchange$okhttp(r3)
            return r7
        L6a:
            okhttp3.ResponseBody r0 = r7.body()     // Catch: java.lang.Throwable -> Le3
            if (r0 == 0) goto L75
            java.io.Closeable r0 = (java.io.Closeable) r0     // Catch: java.lang.Throwable -> Le3
            okhttp3.internal.Util.closeQuietly(r0)     // Catch: java.lang.Throwable -> Le3
        L75:
            int r8 = r8 + 1
            r0 = 20
            if (r8 > r0) goto L80
            ...
            goto L18
        L80:
            java.net.ProtocolException r11 = new java.net.ProtocolException     // Catch: java.lang.Throwable -> Le3
            ...
            java.lang.StringBuilder r0 = r0.append(r8)     // Catch: java.lang.Throwable -> Le3
        ...
        L99:
            r6 = move-exception
            boolean r9 = r6 instanceof okhttp3.internal.http2.ConnectionShutdownException     // Catch: java.lang.Throwable -> Le3
            if (r9 != 0) goto La0
            r9 = r5
            goto La1
        La0:
            r9 = r3
        La1:
            boolean r9 = r10.recover(r6, r1, r0, r9)     // Catch: java.lang.Throwable -> Le3
            if (r9 == 0) goto Lae
            java.util.Collection r2 = (java.util.Collection) r2     // Catch: java.lang.Throwable -> Le3
            java.util.List r2 = kotlin.collections.CollectionsKt.plus(r2, r6)     // Catch: java.lang.Throwable -> Le3
            goto Lca
        Lae:
            java.lang.Exception r6 = (java.lang.Exception) r6     // Catch: java.lang.Throwable -> Le3
            java.lang.Throwable r11 = okhttp3.internal.Util.withSuppressed(r6, r2)     // Catch: java.lang.Throwable -> Le3
            throw r11     // Catch: java.lang.Throwable -> Le3
        Lb5:
            r6 = move-exception
            java.io.IOException r9 = r6.getLastConnectException()     // Catch: java.lang.Throwable -> Le3
            boolean r9 = r10.recover(r9, r1, r0, r3)     // Catch: java.lang.Throwable -> Le3
            if (r9 == 0) goto Ld0
            java.util.Collection r2 = (java.util.Collection) r2     // Catch: java.lang.Throwable -> Le3
            java.io.IOException r6 = r6.getFirstConnectException()     // Catch: java.lang.Throwable -> Le3
            java.util.List r2 = kotlin.collections.CollectionsKt.plus(r2, r6)     // Catch: java.lang.Throwable -> Le3
        Lca:
            r1.exitNetworkInterceptorExchange$okhttp(r5)
            r6 = r3
            goto L19
        Ld0:
            java.io.IOException r11 = r6.getFirstConnectException()     // Catch: java.lang.Throwable -> Le3
            java.lang.Exception r11 = (java.lang.Exception) r11     // Catch: java.lang.Throwable -> Le3
            java.lang.Throwable r11 = okhttp3.internal.Util.withSuppressed(r11, r2)     // Catch: java.lang.Throwable -> Le3
            throw r11     // Catch: java.lang.Throwable -> Le3
        Ldb:
            java.io.IOException r11 = new java.io.IOException     // Catch: java.lang.Throwable -> Le3
