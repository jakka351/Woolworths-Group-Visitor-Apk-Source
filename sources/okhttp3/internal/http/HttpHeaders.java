...
public final class HttpHeaders {
    ...
    */
    ...
    public static final boolean promisesBody(okhttp3.Response response) {
        ...
        return (((iCode >= 100 && iCode < 200) || iCode == 204 || iCode == 304) && Util.headersContentLength(response) == -1 && !StringsKt.equals("chunked", okhttp3.Response.header$default(response, "Transfer-Encoding", null, 2, null), true)) ? false : true;
    }
