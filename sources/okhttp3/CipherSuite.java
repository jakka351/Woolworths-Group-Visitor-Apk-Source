...
public final class CipherSuite {
    ...
    static {
        ...
        TLS_DHE_DSS_WITH_AES_256_CBC_SHA256 = companion.init("TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", RCTMLNShapeSourceManager.METHOD_GET_CLUSTER_CHILDREN);
        TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 = companion.init("TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", RCTMLNShapeSourceManager.METHOD_GET_CLUSTER_EXPANSION_ZOOM_BY_ID);
        ...
        TLS_RSA_WITH_SEED_CBC_SHA = companion.init("TLS_RSA_WITH_SEED_CBC_SHA", MapLibreConstants.ANIMATION_DURATION_SHORT);
