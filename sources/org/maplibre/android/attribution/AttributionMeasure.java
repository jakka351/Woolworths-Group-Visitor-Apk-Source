...
public class AttributionMeasure {
    ...
    public AttributionLayout measure() {
        AttributionLayout attributionLayoutStart = new Chain(new FullLogoLongTextCommand(), new FullLogoShortTextCommand(), new SmallLogoLongTextCommand(), new SmallLogoShortTextCommand(), new LongTextCommand(), new ShortTextCommand(), new NoTextCommand()).start(this);
