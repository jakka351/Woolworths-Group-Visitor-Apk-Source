...
public abstract class Layer {
    ...
    public void setProperties(PropertyValue<?>... propertyValueArr) {
        ...
        for (PropertyValue<?> propertyValue : propertyValueArr) {
            Object objConvertValue = convertValue(propertyValue.value);
            if (propertyValue instanceof PaintPropertyValue) {
                nativeSetPaintProperty(propertyValue.name, objConvertValue);
            } else {
                nativeSetLayoutProperty(propertyValue.name, objConvertValue);
            }
        }
    }
