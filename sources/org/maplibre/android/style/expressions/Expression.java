...
public class Expression {
    ...
    public static Expression color(int i) {
        ...
        return rgba(Float.valueOf(fArrColorToRgbaArray[0]), Float.valueOf(fArrColorToRgbaArray[1]), Float.valueOf(fArrColorToRgbaArray[2]), Float.valueOf(fArrColorToRgbaArray[3]));
    }
    ...
    public static Expression any(Expression... expressionArr) {
        return new Expression(DeviceCountryModule.TYPE_ANY, expressionArr);
    }
    ...
    public static Expression switchCase(Expression... expressionArr) {
        return new Expression(Constants.SENSITIVITY_CASE, expressionArr);
    }
    ...
    public static Expression length(Expression expression) {
        return new Expression(SentryEnvelopeItemHeader.JsonKeys.LENGTH, expression);
    }
    ...
    public static Expression pi() {
        return new Expression(ContextChain.TAG_PRODUCT_AND_INFRA, new Expression[0]);
    }
    ...
    public static Expression min(Expression... expressionArr) {
        return new Expression(MetricSummary.JsonKeys.MIN, expressionArr);
    }
    ...
    public static Expression max(Expression... expressionArr) {
        return new Expression(MetricSummary.JsonKeys.MAX, expressionArr);
    }
    ...
    public static Expression numberFormat(Expression expression, NumberFormatOption... numberFormatOptionArr) {
        ...
        for (NumberFormatOption numberFormatOption : numberFormatOptionArr) {
            map.put(numberFormatOption.type, numberFormatOption.value);
        }
        return new Expression("number-format", expression, new ExpressionMap(map));
    }
    ...
    public static Expression collator(boolean z, boolean z2, Locale locale) {
        HashMap map = new HashMap();
        map.put("case-sensitive", literal(z));
        map.put("diacritic-sensitive", literal(z2));
        ...
        map.put("locale", literal(sb.toString()));
    ...
    public static Expression collator(Expression expression, Expression expression2, Expression expression3) {
        HashMap map = new HashMap();
        map.put("case-sensitive", expression);
        map.put("diacritic-sensitive", expression2);
        map.put("locale", expression3);
        return new Expression("collator", new ExpressionMap(map));
    }
        ...
        while (i < length) {
            ...
            if (formatEntry.options != null) {
                for (FormatOption formatOption : formatEntry.options) {
                    map.put(formatOption.type, formatOption.value);
                }
            }
            expressionArr[i3] = new ExpressionMap(map);
            i++;
            i2 = i3 + 1;
        }
    ...
    public static class Stop {
        ...
        static Expression[] toExpressionArray(Stop... stopArr) {
            ...
            for (int i = 0; i < stopArr.length; i++) {
                Stop stop = stopArr[i];
                Object objLiteral = stop.value;
                Object objLiteral2 = stop.output;
                if (!(objLiteral instanceof Expression)) {
                    objLiteral = Expression.literal(objLiteral);
                }
                if (!(objLiteral2 instanceof Expression)) {
                    objLiteral2 = Expression.literal(objLiteral2);
                }
                int i2 = i * 2;
                expressionArr[i2] = (Expression) objLiteral;
                expressionArr[i2 + 1] = (Expression) objLiteral2;
            }
        ...
        public static Expression convert(JsonElement jsonElement) {
            ...
            if (jsonElement instanceof JsonObject) {
                ...
                for (String str : jsonObject.keySet()) {
                    map.put(str, convert(jsonObject.get(str)));
                }
        ...
        public Object toValue() {
            ...
            for (String str : this.map.keySet()) {
                ...
                if (expression instanceof ValueExpression) {
                    map.put(str, ((ValueExpression) expression).toValue());
                } else {
                    map.put(str, expression.toArray());
                }
            }
            return map;
        }
