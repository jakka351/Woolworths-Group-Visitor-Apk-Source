...
public class CircleOptions extends Options<Circle> {
    ...
    /* bridge */ /* synthetic */ Annotation build(long j, AnnotationManager annotationManager) {
        return build(j, (AnnotationManager<?, Circle, ?, ?, ?, ?>) annotationManager);
    }
    ...
    @Override // org.maplibre.android.plugins.annotation.Options
    Circle build(long j, AnnotationManager<?, Circle, ?, ?, ?, ?> annotationManager) {
        if (this.geometry == null) {
