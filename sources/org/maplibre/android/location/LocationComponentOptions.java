...
public class LocationComponentOptions implements Parcelable {
    ...
    public static LocationComponentOptions createFromAttributes(Context context, int i) throws Resources.NotFoundException {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(i, R.styleable.maplibre_LocationComponent);
        Builder builderPadding = new Builder().enableStaleState(true).staleStateTimeout(30000L).maxZoomIconScale(1.0f).minZoomIconScale(MIN_ZOOM_ICON_SCALE_DEFAULT).padding(PADDING_DEFAULT);
        builderPadding.foregroundDrawable(typedArrayObtainStyledAttributes.getResourceId(R.styleable.maplibre_LocationComponent_maplibre_foregroundDrawable, -1));
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_foregroundTintColor)) {
            builderPadding.foregroundTintColor(Integer.valueOf(typedArrayObtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_foregroundTintColor, -1)));
        }
        builderPadding.backgroundDrawable(typedArrayObtainStyledAttributes.getResourceId(R.styleable.maplibre_LocationComponent_maplibre_backgroundDrawable, -1));
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_backgroundTintColor)) {
            builderPadding.backgroundTintColor(Integer.valueOf(typedArrayObtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_backgroundTintColor, -1)));
        }
        builderPadding.foregroundDrawableStale(typedArrayObtainStyledAttributes.getResourceId(R.styleable.maplibre_LocationComponent_maplibre_foregroundDrawableStale, -1));
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_foregroundStaleTintColor)) {
            builderPadding.foregroundStaleTintColor(Integer.valueOf(typedArrayObtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_foregroundStaleTintColor, -1)));
        }
        builderPadding.backgroundDrawableStale(typedArrayObtainStyledAttributes.getResourceId(R.styleable.maplibre_LocationComponent_maplibre_backgroundDrawableStale, -1));
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_backgroundStaleTintColor)) {
            builderPadding.backgroundStaleTintColor(Integer.valueOf(typedArrayObtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_backgroundStaleTintColor, -1)));
        }
        builderPadding.bearingDrawable(typedArrayObtainStyledAttributes.getResourceId(R.styleable.maplibre_LocationComponent_maplibre_bearingDrawable, -1));
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_bearingTintColor)) {
            builderPadding.bearingTintColor(Integer.valueOf(typedArrayObtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_bearingTintColor, -1)));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_enableStaleState)) {
            builderPadding.enableStaleState(typedArrayObtainStyledAttributes.getBoolean(R.styleable.maplibre_LocationComponent_maplibre_enableStaleState, true));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_staleStateTimeout)) {
            builderPadding.staleStateTimeout(typedArrayObtainStyledAttributes.getInteger(R.styleable.maplibre_LocationComponent_maplibre_staleStateTimeout, HttpUrlConnectionNetworkFetcher.HTTP_DEFAULT_TIMEOUT));
        }
        builderPadding.gpsDrawable(typedArrayObtainStyledAttributes.getResourceId(R.styleable.maplibre_LocationComponent_maplibre_gpsDrawable, -1));
        float dimension = typedArrayObtainStyledAttributes.getDimension(R.styleable.maplibre_LocationComponent_maplibre_elevation, 0.0f);
        builderPadding.accuracyColor(typedArrayObtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_accuracyColor, -1));
        builderPadding.accuracyAlpha(typedArrayObtainStyledAttributes.getFloat(R.styleable.maplibre_LocationComponent_maplibre_accuracyAlpha, 0.15f));
        builderPadding.elevation(dimension);
        builderPadding.trackingGesturesManagement(typedArrayObtainStyledAttributes.getBoolean(R.styleable.maplibre_LocationComponent_maplibre_trackingGesturesManagement, false));
        builderPadding.trackingInitialMoveThreshold(typedArrayObtainStyledAttributes.getDimension(R.styleable.maplibre_LocationComponent_maplibre_trackingInitialMoveThreshold, context.getResources().getDimension(R.dimen.maplibre_locationComponentTrackingInitialMoveThreshold)));
        builderPadding.trackingMultiFingerMoveThreshold(typedArrayObtainStyledAttributes.getDimension(R.styleable.maplibre_LocationComponent_maplibre_trackingMultiFingerMoveThreshold, context.getResources().getDimension(R.dimen.maplibre_locationComponentTrackingMultiFingerMoveThreshold)));
        builderPadding.padding(new int[]{typedArrayObtainStyledAttributes.getInt(R.styleable.maplibre_LocationComponent_maplibre_iconPaddingLeft, 0), typedArrayObtainStyledAttributes.getInt(R.styleable.maplibre_LocationComponent_maplibre_iconPaddingTop, 0), typedArrayObtainStyledAttributes.getInt(R.styleable.maplibre_LocationComponent_maplibre_iconPaddingRight, 0), typedArrayObtainStyledAttributes.getInt(R.styleable.maplibre_LocationComponent_maplibre_iconPaddingBottom, 0)});
        builderPadding.layerAbove(typedArrayObtainStyledAttributes.getString(R.styleable.maplibre_LocationComponent_maplibre_layer_above));
        builderPadding.layerBelow(typedArrayObtainStyledAttributes.getString(R.styleable.maplibre_LocationComponent_maplibre_layer_below));
        float f = typedArrayObtainStyledAttributes.getFloat(R.styleable.maplibre_LocationComponent_maplibre_minZoomIconScale, MIN_ZOOM_ICON_SCALE_DEFAULT);
        float f2 = typedArrayObtainStyledAttributes.getFloat(R.styleable.maplibre_LocationComponent_maplibre_maxZoomIconScale, 1.0f);
        builderPadding.minZoomIconScale(f);
        builderPadding.maxZoomIconScale(f2);
        builderPadding.trackingAnimationDurationMultiplier(typedArrayObtainStyledAttributes.getFloat(R.styleable.maplibre_LocationComponent_maplibre_trackingAnimationDurationMultiplier, TRACKING_ANIMATION_DURATION_MULTIPLIER_DEFAULT));
        builderPadding.compassAnimationEnabled = Boolean.valueOf(typedArrayObtainStyledAttributes.getBoolean(R.styleable.maplibre_LocationComponent_maplibre_compassAnimationEnabled, true));
        builderPadding.accuracyAnimationEnabled = Boolean.valueOf(typedArrayObtainStyledAttributes.getBoolean(R.styleable.maplibre_LocationComponent_maplibre_accuracyAnimationEnabled, true));
        builderPadding.pulseEnabled = Boolean.valueOf(typedArrayObtainStyledAttributes.getBoolean(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleEnabled, false));
        builderPadding.pulseFadeEnabled = Boolean.valueOf(typedArrayObtainStyledAttributes.getBoolean(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleFadeEnabled, true));
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleColor)) {
            builderPadding.pulseColor(typedArrayObtainStyledAttributes.getColor(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleColor, -1));
        }
        builderPadding.pulseSingleDuration = typedArrayObtainStyledAttributes.getFloat(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleDuration, 2300.0f);
        builderPadding.pulseMaxRadius = typedArrayObtainStyledAttributes.getFloat(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleRadius, 35.0f);
        builderPadding.pulseAlpha = typedArrayObtainStyledAttributes.getFloat(R.styleable.maplibre_LocationComponent_maplibre_pulsingLocationCircleAlpha, 1.0f);
        typedArrayObtainStyledAttributes.recycle();
        return builderPadding.build();
    }
    ...
    public int hashCode() {
        ...
        int iFloatToIntBits = (((((f != 0.0f ? Float.floatToIntBits(f) : 0) * 31) + this.accuracyColor) * 31) + this.backgroundDrawableStale) * 31;
        String str = this.backgroundStaleName;
        int iHashCode = (((iFloatToIntBits + (str != null ? str.hashCode() : 0)) * 31) + this.foregroundDrawableStale) * 31;
        String str2 = this.foregroundStaleName;
        int iHashCode2 = (((iHashCode + (str2 != null ? str2.hashCode() : 0)) * 31) + this.gpsDrawable) * 31;
        String str3 = this.gpsName;
        int iHashCode3 = (((iHashCode2 + (str3 != null ? str3.hashCode() : 0)) * 31) + this.foregroundDrawable) * 31;
        String str4 = this.foregroundName;
        int iHashCode4 = (((iHashCode3 + (str4 != null ? str4.hashCode() : 0)) * 31) + this.backgroundDrawable) * 31;
        String str5 = this.backgroundName;
        int iHashCode5 = (((iHashCode4 + (str5 != null ? str5.hashCode() : 0)) * 31) + this.bearingDrawable) * 31;
        String str6 = this.bearingName;
        ...
        Integer num5 = this.backgroundStaleTintColor;
        int iHashCode11 = (iHashCode10 + (num5 != null ? num5.hashCode() : 0)) * 31;
        float f2 = this.elevation;
        int iFloatToIntBits2 = (((iHashCode11 + (f2 != 0.0f ? Float.floatToIntBits(f2) : 0)) * 31) + (this.enableStaleState ? 1 : 0)) * 31;
        long j = this.staleStateTimeout;
        int iHashCode12 = (((iFloatToIntBits2 + ((int) (j ^ (j >>> 32)))) * 31) + Arrays.hashCode(this.padding)) * 31;
        float f3 = this.maxZoomIconScale;
        int iFloatToIntBits3 = (iHashCode12 + (f3 != 0.0f ? Float.floatToIntBits(f3) : 0)) * 31;
        float f4 = this.minZoomIconScale;
        int iFloatToIntBits4 = (((iFloatToIntBits3 + (f4 != 0.0f ? Float.floatToIntBits(f4) : 0)) * 31) + (this.trackingGesturesManagement ? 1 : 0)) * 31;
        ...
        RectF rectF = this.trackingMultiFingerProtectedMoveArea;
        int iHashCode13 = (iFloatToIntBits6 + (rectF != null ? rectF.hashCode() : 0)) * 31;
        String str7 = this.layerAbove;
        ...
        int iFloatToIntBits7 = (((((((((iHashCode15 + (f7 != 0.0f ? Float.floatToIntBits(f7) : 0)) * 31) + (this.compassAnimationEnabled ? 1 : 0)) * 31) + (this.accuracyAnimationEnabled ? 1 : 0)) * 31) + (this.pulseEnabled.booleanValue() ? 1 : 0)) * 31) + (this.pulseFadeEnabled.booleanValue() ? 1 : 0)) * 31;
        Integer num6 = this.pulseColor;
        int iHashCode16 = (iFloatToIntBits7 + (num6 != null ? num6.hashCode() : 0)) * 31;
        float f8 = this.pulseSingleDuration;
        int iFloatToIntBits8 = (iHashCode16 + (f8 != 0.0f ? Float.floatToIntBits(f8) : 0)) * 31;
        float f9 = this.pulseMaxRadius;
        int iFloatToIntBits9 = (iFloatToIntBits8 + (f9 != 0.0f ? Float.floatToIntBits(f9) : 0)) * 31;
        float f10 = this.pulseAlpha;
        return iFloatToIntBits9 + (f10 != 0.0f ? Float.floatToIntBits(f10) : 0);
    }
    ...
    public static class Builder {
        ...
        public LocationComponentOptions build() {
            LocationComponentOptions locationComponentOptionsAutoBuild = autoBuild();
            if (locationComponentOptionsAutoBuild.accuracyAlpha() < 0.0f || locationComponentOptionsAutoBuild.accuracyAlpha() > 1.0f) {
                throw new IllegalArgumentException("Accuracy alpha value must be between 0.0 and 1.0.");
            }
            if (locationComponentOptionsAutoBuild.elevation() < 0.0f) {
                throw new IllegalArgumentException("Invalid shadow size " + locationComponentOptionsAutoBuild.elevation() + ". Must be >= 0");
            }
            if (locationComponentOptionsAutoBuild.layerAbove() != null && locationComponentOptionsAutoBuild.layerBelow() != null) {
                throw new IllegalArgumentException("You cannot set both layerAbove and layerBelow options. Choose one or the other.");
            }
            if (locationComponentOptionsAutoBuild.pulseEnabled() == null) {
                String str = locationComponentOptionsAutoBuild.pulseFadeEnabled() != null ? " pulseFadeEnabled" : "";
                if (locationComponentOptionsAutoBuild.pulseColor() != null) {
                    str = str + " pulseColor";
                }
                if (locationComponentOptionsAutoBuild.pulseSingleDuration() > 0.0f) {
                    str = str + " pulseSingleDuration";
                }
                if (locationComponentOptionsAutoBuild.pulseMaxRadius() > 0.0f) {
                    str = str + " pulseMaxRadius";
                }
                if (locationComponentOptionsAutoBuild.pulseAlpha() >= 0.0f && locationComponentOptionsAutoBuild.pulseAlpha() <= 1.0f) {
                    str = str + " pulseAlpha";
                }
                if (locationComponentOptionsAutoBuild.pulseInterpolator() != null) {
            ...
            return locationComponentOptionsAutoBuild;
        }
