...
public class Style {
    ...
    public void addImages(HashMap<String, Bitmap> map) {
        addImages(map, false);
    }

    public void addImages(HashMap<String, Bitmap> map, List<ImageStretches> list, List<ImageStretches> list2, ImageContent imageContent) {
        addImages(map, false, list, list2, imageContent);
    }

    public void addImages(HashMap<String, Bitmap> map, boolean z) {
        validateState("addImage");
        Image[] imageArr = new Image[map.size()];
        int i = 0;
        for (Builder.ImageWrapper imageWrapper : Builder.ImageWrapper.convertToImageArray(map, z)) {
    ...
    public void addImages(HashMap<String, Bitmap> map, boolean z, List<ImageStretches> list, List<ImageStretches> list2, ImageContent imageContent) {
        validateState("addImage");
        Image[] imageArr = new Image[map.size()];
        Builder.ImageWrapper[] imageWrapperArrConvertToImageArray = Builder.ImageWrapper.convertToImageArray(map, z, list, list2, imageContent);
        int i = 0;
        for (Builder.ImageWrapper imageWrapper : imageWrapperArrConvertToImageArray) {
            imageArr[i] = toImage(imageWrapper);
            i++;
        }
        this.nativeMap.addImages(imageArr);
    ...
    public void addImagesAsync(HashMap<String, Bitmap> map) {
        addImagesAsync(map, false);
    }

    public void addImagesAsync(HashMap<String, Bitmap> map, List<ImageStretches> list, List<ImageStretches> list2, ImageContent imageContent) {
        addImagesAsync(map, false, list, list2, imageContent);
    }

    public void addImagesAsync(HashMap<String, Bitmap> map, boolean z) {
        validateState("addImages");
        new BitmapImageConversionTask(this.nativeMap).execute(Builder.ImageWrapper.convertToImageArray(map, z));
    }

    public void addImagesAsync(HashMap<String, Bitmap> map, boolean z, List<ImageStretches> list, List<ImageStretches> list2, ImageContent imageContent) {
        validateState("addImages");
        new BitmapImageConversionTask(this.nativeMap).execute(Builder.ImageWrapper.convertToImageArray(map, z, list, list2, imageContent));
    }
    ...
    public static class Builder {
        ...
        public static class ImageWrapper {
            ...
            public static ImageWrapper[] convertToImageArray(HashMap<String, Bitmap> map, boolean z) {
                ImageWrapper[] imageWrapperArr = new ImageWrapper[map.size()];
                ArrayList arrayList = new ArrayList(map.keySet());
                for (int i = 0; i < map.size(); i++) {
                    String str = (String) arrayList.get(i);
                    imageWrapperArr[i] = new ImageWrapper(str, map.get(str), z);
                }
                return imageWrapperArr;
            }

            public static ImageWrapper[] convertToImageArray(HashMap<String, Bitmap> map, boolean z, List<ImageStretches> list, List<ImageStretches> list2, ImageContent imageContent) {
                ImageWrapper[] imageWrapperArr = new ImageWrapper[map.size()];
                ArrayList arrayList = new ArrayList(map.keySet());
                for (int i = 0; i < map.size(); i++) {
                    String str = (String) arrayList.get(i);
                    imageWrapperArr[i] = new ImageWrapper(str, map.get(str), z, list, list2, imageContent);
                }
                return imageWrapperArr;
            }
        }
    ...
    public static Image toImage(Builder.ImageWrapper imageWrapper) {
        Bitmap bitmapCopy = imageWrapper.bitmap;
        if (bitmapCopy.getConfig() != Bitmap.Config.ARGB_8888) {
            bitmapCopy = bitmapCopy.copy(Bitmap.Config.ARGB_8888, false);
        }
        ByteBuffer byteBufferAllocate = ByteBuffer.allocate(bitmapCopy.getByteCount());
        bitmapCopy.copyPixelsToBuffer(byteBufferAllocate);
        float density = bitmapCopy.getDensity() / 160.0f;
        if (imageWrapper.getStretchX() != null && imageWrapper.getStretchY() != null) {
            ...
            return new Image(byteBufferAllocate.array(), density, imageWrapper.id, bitmapCopy.getWidth(), bitmapCopy.getHeight(), imageWrapper.sdf, fArr, fArr2, imageWrapper.getContent() == null ? null : imageWrapper.getContent().getContentArray());
        }
        return new Image(byteBufferAllocate.array(), density, imageWrapper.id, bitmapCopy.getWidth(), bitmapCopy.getHeight(), imageWrapper.sdf);
    }
