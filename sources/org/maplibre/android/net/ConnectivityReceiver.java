...
public class ConnectivityReceiver extends BroadcastReceiver {
    ...
    public void setConnected(Boolean bool) {
        boolean zIsNetworkActive;
        this.connected = bool;
        if (bool != null) {
            zIsNetworkActive = bool.booleanValue();
        } else {
            zIsNetworkActive = isNetworkActive();
        }
        notifyListeners(zIsNetworkActive);
    }
