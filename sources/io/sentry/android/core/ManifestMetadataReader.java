...
final class ManifestMetadataReader {
    ...
    static void applyMetadata(Context context, SentryAndroidOptions sentryAndroidOptions, BuildInfoProvider buildInfoProvider) {
        ...
        try {
            ...
            if (metadata != null) {
                ...
                sentryAndroidOptions.getExperimental().getSessionReplay().setRedactAllText(readBool(metadata, logger, REPLAYS_REDACT_ALL_TEXT, sentryAndroidOptions.getExperimental().getSessionReplay().getRedactAllText()));
                sentryAndroidOptions.getExperimental().getSessionReplay().setRedactAllImages(readBool(metadata, logger, REPLAYS_REDACT_ALL_IMAGES, sentryAndroidOptions.getExperimental().getSessionReplay().getRedactAllImages()));
            }
    ...
    static boolean isAutoInit(Context context, ILogger iLogger) {
        ...
        try {
            ...
            bool = metadata != null ? readBool(metadata, iLogger, AUTO_INIT, true) : true;
