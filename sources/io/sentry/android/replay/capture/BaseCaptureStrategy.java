...
public abstract class BaseCaptureStrategy implements CaptureStrategy {
    ...
    public BaseCaptureStrategy(SentryOptions options, IHub iHub, ICurrentDateProvider dateProvider, final ScheduledExecutorService scheduledExecutorService, Function2<? super SentryId, ? super ScreenshotRecorderConfig, ReplayCache> function2) {
        ...
        this.recorderConfig = new ReadWriteProperty<Object, ScreenshotRecorderConfig>(obj, this, str, this) { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$1
            ...
            private final void runInBackground(final Function0<Unit> task) {
                if (this.this$0$inline_fun.options.getMainThreadChecker().isMainThread()) {
                    ExecutorsKt.submitSafely(this.this$0$inline_fun.getPersistingExecutor(), this.this$0$inline_fun.options, "CaptureStrategy.runInBackground", new Runnable() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$1.2
        ...
        this.segmentTimestamp = new ReadWriteProperty<Object, Date>(obj, this, str2, this) { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomicNullable$default$1
            ...
            private final void runInBackground(final Function0<Unit> task) {
                if (this.this$0$inline_fun.options.getMainThreadChecker().isMainThread()) {
                    ExecutorsKt.submitSafely(this.this$0$inline_fun.getPersistingExecutor(), this.this$0$inline_fun.options, "CaptureStrategy.runInBackground", new Runnable() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomicNullable$default$1.2
                        @Override // java.lang.Runnable
                        public final void run() {
                            task.invoke();
                        }
        ...
        this.screenAtStart = new ReadWriteProperty<Object, String>(obj2, this, str3, this, str3) { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomicNullable$default$2
...

            {
                ...
                runInBackground(new Function0<Unit>() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomicNullable$default$2.1
                    ...
                    public final void invoke2() {
                        ...
                        ReplayCache cache = this.getCache();
                        if (cache != null) {
                            cache.persistSegmentValues(str3, String.valueOf(obj3));
                        }
                    }
                });
            }
            ...
            private final void runInBackground(final Function0<Unit> task) {
                if (this.this$0$inline_fun.options.getMainThreadChecker().isMainThread()) {
                    ExecutorsKt.submitSafely(this.this$0$inline_fun.getPersistingExecutor(), this.this$0$inline_fun.options, "CaptureStrategy.runInBackground", new Runnable() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomicNullable$default$2.2
                        @Override // java.lang.Runnable
                        public final void run() {
                            task.invoke();
                        }
        ...
        this.currentReplayId = new ReadWriteProperty<Object, SentryId>(sentryId, this, str4, this, str4) { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$default$1
...

            {
                ...
                runInBackground(new Function0<Unit>() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$default$1.1
                    ...
                    /* renamed from: invoke, reason: avoid collision after fix types in other method */
                    public final void invoke2() {
                        Object obj3 = sentryId;
                        ReplayCache cache = this.getCache();
                        if (cache != null) {
                            cache.persistSegmentValues(str4, String.valueOf(obj3));
                        }
                    }
                });
            }
            ...
            private final void runInBackground(final Function0<Unit> task) {
                if (this.this$0$inline_fun.options.getMainThreadChecker().isMainThread()) {
                    ExecutorsKt.submitSafely(this.this$0$inline_fun.getPersistingExecutor(), this.this$0$inline_fun.options, "CaptureStrategy.runInBackground", new Runnable() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$default$1.2
                        @Override // java.lang.Runnable
                        public final void run() {
                            task.invoke();
                        }
        ...
        this.currentSegment = new ReadWriteProperty<Object, Integer>(i, this, str5, this, str5) { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$default$2
            ...
            private final void runInBackground(final Function0<Unit> task) {
                if (this.this$0$inline_fun.options.getMainThreadChecker().isMainThread()) {
                    ExecutorsKt.submitSafely(this.this$0$inline_fun.getPersistingExecutor(), this.this$0$inline_fun.options, "CaptureStrategy.runInBackground", new Runnable() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$default$2.2
                        @Override // java.lang.Runnable
                        public final void run() {
                            task.invoke();
                        }
        ...
        this.replayType = new ReadWriteProperty<Object, SentryReplayEvent.ReplayType>(obj3, this, str6, this, str6) { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$default$3
            ...
            private final void runInBackground(final Function0<Unit> task) {
                if (this.this$0$inline_fun.options.getMainThreadChecker().isMainThread()) {
                    ExecutorsKt.submitSafely(this.this$0$inline_fun.getPersistingExecutor(), this.this$0$inline_fun.options, "CaptureStrategy.runInBackground", new Runnable() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy$special$$inlined$persistableAtomic$default$3.2
                        @Override // java.lang.Runnable
                        public final void run() {
                            task.invoke();
                        }
    ...
    public static final class AnonymousClass2<T> implements ReadWriteProperty<Object, T> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public AnonymousClass2(final T t, BaseCaptureStrategy baseCaptureStrategy, final Function3<? super String, ? super T, ? super T, Unit> function3, final String str) {
            this.this$0 = baseCaptureStrategy;
            this.$onChange = function3;
            this.$propertyName = str;
            this.value = new AtomicReference<>(t);
            runInBackground(new Function0<Unit>() { // from class: io.sentry.android.replay.capture.BaseCaptureStrategy.persistableAtomicNullable.2.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(0);
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    Function3<String, T, T, Unit> function32 = function3;
                    String str2 = str;
                    T t2 = t;
                    function32.invoke(str2, t2, t2);
                }
            });
        }
