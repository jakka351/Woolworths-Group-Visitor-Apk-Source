    ...
    */
    ...
    public SentryId captureReplayEvent(SentryReplayEvent sentryReplayEvent, IScope iScope, Hint hint) {
        ...
        if (sentryReplayEventProcessReplayEvent == null) {
            this.options.getLogger().log(SentryLevel.DEBUG, "Replay was dropped by Event processors.", new Object[0]);
            ...
            if (iScope != null) {
                return iScope.withSession(new Scope.IWithSession() { // from class: io.sentry.SentryClient$$ExternalSyntheticLambda1
                    ...
                    public final void accept(Session session) {
                        this.f$0.m1022lambda$updateSessionData$1$iosentrySentryClient(sentryEvent, hint, session);
                    }
                });
            }
    ...
    /* synthetic */ void m1022lambda$updateSessionData$1$iosentrySentryClient(SentryEvent sentryEvent, Hint hint, Session session) {
        if (session == null) {
