...
public final class Hub implements IHub, MetricsApi.IMetricsInterface {
            ...
            if (z) {
                executorService.submit(new Runnable() { // from class: io.sentry.Hub$$ExternalSyntheticLambda3
                    ...
                    public final void run() {
                        this.f$0.m1013lambda$close$1$iosentryHub(executorService);
                    }
                });
            } else {
    ...
    /* synthetic */ void m1013lambda$close$1$iosentryHub(ISentryExecutorService iSentryExecutorService) {
    ...
    public void pushScope() {
        ...
        Stack.StackItem stackItemPeek = this.stack.peek();
        this.stack.push(new Stack.StackItem(this.options, stackItemPeek.getClient(), stackItemPeek.getScope().m1018clone()));
    }
    ...
    public SentryId captureTransaction(SentryTransaction sentryTransaction, TraceContext traceContext, Hint hint, ProfilingTraceData profilingTraceData) {
        ...
        try {
            Stack.StackItem stackItemPeek = this.stack.peek();
            return stackItemPeek.getClient().captureTransaction(sentryTransaction, traceContext, stackItemPeek.getScope(), hint, profilingTraceData);
        } catch (Throwable th) {
    ...
    private IScope buildLocalScope(IScope iScope, ScopeCallback scopeCallback) {
        if (scopeCallback != null) {
            try {
                IScope iScopeM1020clone = iScope.m1018clone();
                scopeCallback.run(iScopeM1020clone);
                return iScopeM1020clone;
            } catch (Throwable th) {
    ...
    public SentryId captureReplay(SentryReplayEvent sentryReplayEvent, Hint hint) {
        ...
        try {
            Stack.StackItem stackItemPeek = this.stack.peek();
            return stackItemPeek.getClient().captureReplayEvent(sentryReplayEvent, stackItemPeek.getScope(), hint);
        } catch (Throwable th) {
