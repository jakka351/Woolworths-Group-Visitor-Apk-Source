...
public final class SentryExceptionFactory {
    ...
    Deque<SentryException> extractExceptionQueue(Throwable th) {
        ...
        while (th != null && hashSet.add(th)) {
            ...
            arrayDeque.addFirst(getSentryException(th, mechanism, Long.valueOf(threadCurrentThread.getId()), this.sentryStackTraceFactory.getStackFrames(th.getStackTrace(), z), zIsSnapshot));
            th = th.getCause();
        }
        return arrayDeque;
    }
