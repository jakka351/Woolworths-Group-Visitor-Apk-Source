...
public class NotifeeEventSubscriber implements EventListener {
    ...
    public void onNotificationEvent(NotificationEvent notificationEvent) {
        ...
        writableMapCreateMap2.putMap("notification", Arguments.fromBundle(notificationEvent.getNotification().toBundle()));
        ...
        if (NotifeeReactUtils.isAppInForeground()) {
            ...
            NotifeeReactUtils.startHeadlessTask(NOTIFICATION_EVENT_KEY, writableMapCreateMap, DateUtils.MILLIS_PER_MINUTE, null);
        }
    }
    ...
    public void onForegroundServiceEvent(final ForegroundServiceEvent foregroundServiceEvent) {
        ...
        WritableMap writableMapCreateMap = Arguments.createMap();
        writableMapCreateMap.putMap("notification", Arguments.fromBundle(notification.toBundle()));
