...
public final class SafeAreaContextModule extends NativeSafeAreaContextSpec {
    ...
    public Map<String, Object> getTypedExportedConstants() {
        Map<String, Object> mapOf = MapBuilder.of("initialWindowMetrics", getInitialWindowMetrics());
        Intrinsics.checkNotNullExpressionValue(mapOf, "of<String, Any>(\"initial…etInitialWindowMetrics())");
        return mapOf;
    }
