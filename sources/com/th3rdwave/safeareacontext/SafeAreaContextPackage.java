...
public final class SafeAreaContextPackage extends TurboReactPackage {
    ...
    public ReactModuleInfoProvider getReactModuleInfoProvider() {
        ...
        if (reactModule != null) {
            map.put(reactModule.name(), new ReactModuleInfo(reactModule.name(), cls.getName(), true, reactModule.needsEagerInit(), reactModule.hasConstants(), reactModule.isCxxModule(), TurboModule.class.isAssignableFrom(cls)));
        }
