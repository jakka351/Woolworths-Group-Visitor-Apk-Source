...
public class ReanimatedNativeHierarchyManager extends NativeViewHierarchyManager {
    ...
    public synchronized void updateLayout(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        try {
            ...
            if (viewResolveView != null && name.equals(ScreenViewManager.REACT_CLASS) && this.mReaLayoutAnimator != null && (!checkIfTopScreenHasHeader((ViewGroup) viewResolveView) || !viewResolveView.isLayoutRequested())) {
                this.mReaLayoutAnimator.getAnimationsManager().screenDidLayout(viewResolveView);
            }
            View viewResolveView2 = resolveView(i2);
            if (viewResolveView2 != null && (reaLayoutAnimator = this.mReaLayoutAnimator) != null) {
                reaLayoutAnimator.getAnimationsManager().viewDidLayout(viewResolveView2);
            }
