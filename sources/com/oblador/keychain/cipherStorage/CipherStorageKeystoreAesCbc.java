...
public class CipherStorageKeystoreAesCbc extends CipherStorageBase {
    ...
    public CipherStorage.EncryptionResult encrypt(String str, String str2, String str3, SecurityLevel securityLevel) throws CryptoFailedException {
        ...
        try {
            Key keyExtractGeneratedKey = extractGeneratedKey(getDefaultAliasIfEmpty(str, getDefaultAliasServiceName()), securityLevel, new AtomicInteger(1));
            return new CipherStorage.EncryptionResult(encryptString(keyExtractGeneratedKey, str2), encryptString(keyExtractGeneratedKey, str3), this);
    ...
    public CipherStorage.DecryptionResult decrypt(String str, byte[] bArr, byte[] bArr2, SecurityLevel securityLevel) throws CryptoFailedException {
        ...
        try {
            Key keyExtractGeneratedKey = extractGeneratedKey(getDefaultAliasIfEmpty(str, getDefaultAliasServiceName()), securityLevel, new AtomicInteger(1));
            return new CipherStorage.DecryptionResult(decryptBytes(keyExtractGeneratedKey, bArr), decryptBytes(keyExtractGeneratedKey, bArr2), getSecurityLevel(keyExtractGeneratedKey));
        } catch (GeneralSecurityException e) {
