...
final class zzbo implements ObjectEncoderContext {
    ...
    zzbo(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    final zzbo zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
            zzbm zzbmVarZzj = zzj(fieldDescriptor);
    ...
    final zzbo zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            zzbm zzbmVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zzbmVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
    ...
    final zzbo zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
