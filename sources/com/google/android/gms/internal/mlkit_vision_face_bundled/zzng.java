...
public enum zzng implements zzbk {
    ...
    MODEL_INFO_DOWNLOAD_NO_HASH(RCTMLNShapeSourceManager.METHOD_GET_CLUSTER_CHILDREN),
    MODEL_INFO_DOWNLOAD_CONNECTION_FAILED(RCTMLNShapeSourceManager.METHOD_GET_CLUSTER_EXPANSION_ZOOM_BY_ID),
    NO_VALID_MODEL(108),
