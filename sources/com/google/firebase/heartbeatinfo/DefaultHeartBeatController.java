...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
    ...
    /* synthetic */ Void m844x734756b4() throws Exception {
        synchronized (this) {
    ...
    /* synthetic */ String m843x341e14f2() throws Exception {
        String string;
        synchronized (this) {
            ...
            try {
                ...
                try {
                    ...
                    string = byteArrayOutputStream.toString(CharEncoding.UTF_8);
                } finally {
                }
            } finally {
            }
