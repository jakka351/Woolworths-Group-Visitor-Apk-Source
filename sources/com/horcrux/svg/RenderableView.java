...
public abstract class RenderableView extends VirtualView implements ReactHitSlopView {
    ...
    void render(Canvas canvas, Paint paint, float f) {
        ...
        if (maskView != null) {
            ...
            int iHeight = clipBounds.height();
            int iWidth = clipBounds.width();
            ...
            Bitmap bitmapCreateBitmap3 = Bitmap.createBitmap(iWidth, iHeight, Bitmap.Config.ARGB_8888);
            ...
            canvas3.clipRect(fRelativeOnWidth, fRelativeOnHeight, ((float) relativeOnWidth(maskView.mW)) + fRelativeOnWidth, ((float) relativeOnHeight(maskView.mH)) + fRelativeOnHeight);
            Paint paint2 = new Paint(1);
            maskView.draw(canvas3, paint2, 1.0f);
            int i = iWidth * iHeight;
            int[] iArr = new int[i];
            bitmapCreateBitmap.getPixels(iArr, 0, iWidth, 0, 0, iWidth, iHeight);
            int i2 = 0;
            while (i2 < i) {
                int i3 = iArr[i2];
            ...
            Paint paint3 = paint2;
            bitmapCreateBitmap.setPixels(iArr, 0, iWidth, 0, 0, iWidth, iHeight);
            draw(canvas2, paint, f);
            paint3.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
            canvas4.drawBitmap(bitmapCreateBitmap2, 0.0f, 0.0f, (Paint) null);
            canvas4.drawBitmap(bitmapCreateBitmap, 0.0f, 0.0f, paint3);
