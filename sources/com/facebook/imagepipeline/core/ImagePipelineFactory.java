...
public class ImagePipelineFactory {
    ...
    public AnimatedCache getAnimatedCache(int i) {
        if (this.mAnimatedCache == null) {
            this.mAnimatedCache = AnimatedCache.getInstance((int) (((Math.min(Runtime.getRuntime().maxMemory(), 2147483647L) / 100) * i) / PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED));
        }
