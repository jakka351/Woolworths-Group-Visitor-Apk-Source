...
public class JavaTimerManager {
    ...
    public void createAndMaybeCallTimer(int i, int i2, double d, boolean z) {
        ...
        long j = (long) d;
        if (this.mDevSupportManager.getDevSupportEnabled() && Math.abs(j - jCurrentTimeMillis) > DateUtils.MILLIS_PER_MINUTE) {
        ...
        long jMax = Math.max(0L, (j - jCurrentTimeMillis) + i2);
        if (i2 == 0 && !z) {
