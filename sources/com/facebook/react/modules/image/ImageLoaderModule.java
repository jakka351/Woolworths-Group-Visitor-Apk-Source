...
public class ImageLoaderModule extends NativeImageLoaderAndroidSpec implements LifecycleEventListener {
    ...
    @ReactMethod
    public void getSize(String str, final Promise promise) throws NumberFormatException {
    ...
    @Override // com.facebook.fbreact.specs.NativeImageLoaderAndroidSpec
    public void prefetchImage(String str, double d, final Promise promise) throws NumberFormatException {
        final int i = (int) d;
        if (str == null || str.isEmpty()) {
