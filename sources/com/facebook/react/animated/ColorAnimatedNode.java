...
class ColorAnimatedNode extends AnimatedNode implements AnimatedNodeWithUpdateableConfig {
    ...
    private void tryApplyNativeColor() {
        ...
        int iIntValue = ColorPropConverter.getColor(this.mNativeColor, context).intValue();
        ...
        valueAnimatedNode.mValue = Color.red(iIntValue);
        valueAnimatedNode2.mValue = Color.green(iIntValue);
        valueAnimatedNode3.mValue = Color.blue(iIntValue);
        valueAnimatedNode4.mValue = Color.alpha(iIntValue) / 255.0d;
