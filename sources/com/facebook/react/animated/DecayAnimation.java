...
public class DecayAnimation extends AnimationDriver {
    ...
    public void runAnimationStep(long j) {
        ...
        double dExp = d + ((d2 / (1.0d - d3)) * (1.0d - Math.exp((-(1.0d - d3)) * (j2 - this.mStartFrameTimeMillis))));
        if (Math.abs(this.mLastValue - dExp) < 0.1d) {
        ...
        this.mLastValue = dExp;
        this.mAnimatedValue.mValue = dExp;
    }
}
