    ...
    private class TilePostprocessor extends BasePostprocessor {
        ...
        public CloseableReference<Bitmap> process(Bitmap bitmap, PlatformBitmapFactory platformBitmapFactory) {
            ...
            try {
                ...
                return closeableReferenceCreateBitmap.mo386clone();
            } finally {
    ...
    public void setSource(ReadableArray readableArray) {
        ...
        if (readableArray == null || readableArray.size() == 0) {
            ...
            if (readableArray.size() == 1) {
                ...
                ImageSource imageSource = new ImageSource(getContext(), map.getString(ReactNativeBlobUtilConst.DATA_ENCODE_URI));
                ...
                for (int i = 0; i < readableArray.size(); i++) {
                    ...
                    ImageSource imageSource2 = new ImageSource(getContext(), map2.getString(ReactNativeBlobUtilConst.DATA_ENCODE_URI), map2.getDouble("width"), map2.getDouble("height"));
