...
public class FrescoBasedReactTextInlineImageShadowNode extends ReactTextInlineImageShadowNode {
    ...
    private static Uri getResourceDrawableUri(Context context, String str) {
        ...
        return new Uri.Builder().scheme(UriUtil.LOCAL_RESOURCE_SCHEME).path(String.valueOf(context.getResources().getIdentifier(str.toLowerCase(Locale.getDefault()).replace("-", "_"), BuildConfig.FLAVOR, context.getPackageName()))).build();
    }
