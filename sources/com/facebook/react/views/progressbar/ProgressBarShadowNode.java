...
public class ProgressBarShadowNode extends LayoutShadowNode implements YogaMeasureFunction {
    ...
    public long measure(YogaNode yogaNode, float f, YogaMeasureMode yogaMeasureMode, float f2, YogaMeasureMode yogaMeasureMode2) {
        ...
        if (!this.mMeasured.contains(Integer.valueOf(styleFromString))) {
            ...
            this.mHeight.put(styleFromString, progressBarCreateProgressBar.getMeasuredHeight());
            this.mWidth.put(styleFromString, progressBarCreateProgressBar.getMeasuredWidth());
