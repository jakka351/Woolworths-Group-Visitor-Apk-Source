...
class FragmentStateManager {
    ...
    Bundle saveState() {
        ...
        if (this.mFragment.mState > -1) {
            ...
            Bundle bundleM320lambda$attachController$5$androidxfragmentappFragmentManager = this.mFragment.mChildFragmentManager.m320lambda$attachController$5$androidxfragmentappFragmentManager();
            if (!bundleM320lambda$attachController$5$androidxfragmentappFragmentManager.isEmpty()) {
                bundle.putBundle(CHILD_FRAGMENT_MANAGER_KEY, bundleM320lambda$attachController$5$androidxfragmentappFragmentManager);
            }
            if (this.mFragment.mView != null) {
                saveViewState();
            }
