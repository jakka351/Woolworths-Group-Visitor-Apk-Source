        ...
        for (String str : this.mFragments) {
            ...
            if (fragment != null) {
                ...
                if (savedState != null) {
                    ...
                    Fragment fragmentInstantiate = ((FragmentState) savedState.getParcelable(SentryThread.JsonKeys.STATE)).instantiate(fragmentManager.getFragmentFactory(), classLoader);
