...
public class ViewModelProvider {
    ...
    public static class AndroidViewModelFactory extends NewInstanceFactory {
        ...
        private final <T extends ViewModel> T create(Class<T> modelClass, Application app2) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
            if (AndroidViewModel.class.isAssignableFrom(modelClass)) {
                try {
                    T tNewInstance = modelClass.getConstructor(Application.class).newInstance(app2);
                    Intrinsics.checkNotNullExpressionValue(tNewInstance, "{\n                try {\n…          }\n            }");
                    return tNewInstance;
                } catch (IllegalAccessException e) {
                    throw new RuntimeException("Cannot create an instance of " + modelClass, e);
