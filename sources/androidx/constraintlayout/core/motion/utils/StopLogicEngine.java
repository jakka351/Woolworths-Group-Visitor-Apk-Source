...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String str, float f) {
        String str2 = ((str + " ===== " + this.mType + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE) + str + (this.mBackwards ? "backwards" : "forward ") + " time = " + f + "  stages " + this.mNumberOfStages + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE) + str + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
