...
public final class AudioSource {
    ...
    public AudioSource(AudioSettings audioSettings, Executor executor, Context context) throws AudioSourceAccessException {
        this(audioSettings, executor, context, new AudioStreamFactory() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda8
    ...
    public void setBufferProvider(final BufferProvider<? extends InputBuffer> bufferProvider) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda0
            ...
            public final void run() throws IllegalStateException {
                this.f$0.m222x885db6e2(bufferProvider);
            }
        });
    }

    /* renamed from: lambda$setBufferProvider$0$androidx-camera-video-internal-audio-AudioSource, reason: not valid java name */
    /* synthetic */ void m222x885db6e2(BufferProvider bufferProvider) throws IllegalStateException {
    ...
    /* synthetic */ void m223lambda$start$1$androidxcameravideointernalaudioAudioSource() {
        start(this.mMuted);
    }
    ...
    public void start() {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda5
            ...
            public final void run() {
                this.f$0.m223lambda$start$1$androidxcameravideointernalaudioAudioSource();
            }
        });
    }
    ...
    public void start(final boolean z) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() throws IllegalStateException {
                this.f$0.m224lambda$start$2$androidxcameravideointernalaudioAudioSource(z);
            }
        });
    }

    /* renamed from: lambda$start$2$androidx-camera-video-internal-audio-AudioSource, reason: not valid java name */
    /* synthetic */ void m224lambda$start$2$androidxcameravideointernalaudioAudioSource(boolean z) throws IllegalStateException {
        int i = AnonymousClass3.$SwitchMap$androidx$camera$video$internal$audio$AudioSource$InternalState[this.mState.ordinal()];
        if (i != 1) {
            if (i == 3) {
                throw new AssertionError("AudioSource is released");
    ...
    public void stop() {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() throws IllegalStateException {
                this.f$0.m225lambda$stop$3$androidxcameravideointernalaudioAudioSource();
            }
        });
    }

    /* renamed from: lambda$stop$3$androidx-camera-video-internal-audio-AudioSource, reason: not valid java name */
    /* synthetic */ void m225lambda$stop$3$androidxcameravideointernalaudioAudioSource() throws IllegalStateException {
        int i = AnonymousClass3.$SwitchMap$androidx$camera$video$internal$audio$AudioSource$InternalState[this.mState.ordinal()];
        if (i == 2) {
    ...
    public ListenableFuture<Void> release() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda7
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m220xa561a489(completer);
            }
        });
    }

    /* renamed from: lambda$release$5$androidx-camera-video-internal-audio-AudioSource, reason: not valid java name */
    /* synthetic */ Object m220xa561a489(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m219xb3b7fe6a(completer);
            }
        });
    ...
    /* synthetic */ void m219xb3b7fe6a(CallbackToFutureAdapter.Completer completer) {
        try {
            int i = AnonymousClass3.$SwitchMap$androidx$camera$video$internal$audio$AudioSource$InternalState[this.mState.ordinal()];
            if (i == 1 || i == 2) {
    ...
    public void setAudioSourceCallback(final Executor executor, final AudioSourceCallback audioSourceCallback) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m221xcbe526c1(executor, audioSourceCallback);
            }
        });
    }

    /* renamed from: lambda$setAudioSourceCallback$6$androidx-camera-video-internal-audio-AudioSource, reason: not valid java name */
    /* synthetic */ void m221xcbe526c1(Executor executor, AudioSourceCallback audioSourceCallback) {
        int i = AnonymousClass3.$SwitchMap$androidx$camera$video$internal$audio$AudioSource$InternalState[this.mState.ordinal()];
        if (i == 1) {
    ...
    public void mute(final boolean z) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m217lambda$mute$7$androidxcameravideointernalaudioAudioSource(z);
            }
        });
    }

    /* renamed from: lambda$mute$7$androidx-camera-video-internal-audio-AudioSource, reason: not valid java name */
    /* synthetic */ void m217lambda$mute$7$androidxcameravideointernalaudioAudioSource(boolean z) {
        int i = AnonymousClass3.$SwitchMap$androidx$camera$video$internal$audio$AudioSource$InternalState[this.mState.ordinal()];
        if (i != 1 && i != 2) {
            if (i == 3) {
                throw new AssertionError("AudioSource is released");
    ...
    void notifyError(final Throwable th) {
        ...
        executor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
    ...
    void notifySilenced() {
        ...
        executor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    void postMaxAmplitude(ByteBuffer byteBuffer) {
        ...
        if (this.mAudioFormat == 2) {
            ...
            executor.execute(new Runnable() { // from class: androidx.camera.video.internal.audio.AudioSource$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m218xdf9dee1c(audioSourceCallback);
                }
            });
        }
    }
    ...
    /* synthetic */ void m218xdf9dee1c(AudioSourceCallback audioSourceCallback) {
