...
public class EncoderFinder {
    ...
    public MediaCodec findEncoder(MediaFormat mediaFormat) throws Throwable {
        ...
        try {
            ...
            throw new InvalidConfigException("Encoder cannot created: " + strFindEncoderForFormat + ", isMediaFormatInQuirk: " + shouldCreateCodecByType(mediaFormat) + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + DebugUtils.dumpMediaCodecListForFormat(mediaCodecList, mediaFormat), e);
        }
    }
