...
final class CaptureSession implements CaptureSessionInterface {
            ...
            if (AnonymousClass4.$SwitchMap$androidx$camera$camera2$internal$CaptureSession$State[this.mState.ordinal()] == 2) {
                ...
                FutureChain futureChainTransformAsync = FutureChain.from(synchronizedCaptureSessionOpener.startWithDeferrableSurface(arrayList, 5000L)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.CaptureSession$$ExternalSyntheticLambda1
                    ...
                    public final ListenableFuture apply(Object obj) {
                        return this.f$0.m45lambda$open$0$androidxcameracamera2internalCaptureSession(sessionConfig, cameraDevice, (List) obj);
                    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:17:0x0058 A[Catch: all -> 0x00a9, TryCatch #1 {, blocks: (B:4:0x0009, B:5:0x0013, B:28:0x00a2, B:7:0x0018, B:10:0x001e, B:14:0x002a, B:13:0x0023, B:15:0x002f, B:17:0x0058, B:18:0x005c, B:20:0x0060, B:21:0x006b, B:22:0x006d, B:24:0x006f, B:25:0x0088, B:26:0x008d, B:27:0x00a1), top: B:36:0x0009, inners: #0 }] */
    /* JADX WARN: Removed duplicated region for block: B:20:0x0060 A[Catch: all -> 0x00a9, TryCatch #1 {, blocks: (B:4:0x0009, B:5:0x0013, B:28:0x00a2, B:7:0x0018, B:10:0x001e, B:14:0x002a, B:13:0x0023, B:15:0x002f, B:17:0x0058, B:18:0x005c, B:20:0x0060, B:21:0x006b, B:22:0x006d, B:24:0x006f, B:25:0x0088, B:26:0x008d, B:27:0x00a1), top: B:36:0x0009, inners: #0 }] */
    @Override // androidx.camera.camera2.internal.CaptureSessionInterface
    /*
    ...
    */
    ...
    /* synthetic */ Object m46lambda$release$1$androidxcameracamera2internalCaptureSession(CallbackToFutureAdapter.Completer completer) throws Exception {
        String str;
        synchronized (this.mSessionLock) {
                ...
                if (this.mStillCaptureFlow.shouldStopRepeatingBeforeCapture(arrayList, z)) {
                    ...
                    cameraBurstCaptureCallback.setCaptureSequenceCallback(new CameraBurstCaptureCallback.CaptureSequenceCallback() { // from class: androidx.camera.camera2.internal.CaptureSession$$ExternalSyntheticLambda0
                        ...
                        public final void onCaptureSequenceCompletedOrAborted(CameraCaptureSession cameraCaptureSession, int i, boolean z3) {
                            this.f$0.m44xaccd0633(cameraCaptureSession, i, z3);
                        }
                    });
                }
    ...
    /* synthetic */ void m44xaccd0633(CameraCaptureSession cameraCaptureSession, int i, boolean z) {
        synchronized (this.mSessionLock) {
            if (this.mState == State.OPENED) {
                issueRepeatingCaptureRequests(this.mSessionConfig);
            }
