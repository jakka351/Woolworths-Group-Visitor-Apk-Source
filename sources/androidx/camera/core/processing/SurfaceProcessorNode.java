...
public class SurfaceProcessorNode implements Node<In, Out> {
    ...
    private void sendSurfaceOutputs(final SurfaceEdge surfaceEdge, Map<OutConfig, SurfaceEdge> map) {
        for (final Map.Entry<OutConfig, SurfaceEdge> entry : map.entrySet()) {
            m183x8baeb245(surfaceEdge, entry);
            entry.getValue().addOnInvalidatedListener(new Runnable() { // from class: androidx.camera.core.processing.SurfaceProcessorNode$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m183x8baeb245(surfaceEdge, entry);
                }
            });
        }
    }
    ...
    public void m183x8baeb245(SurfaceEdge surfaceEdge, Map.Entry<OutConfig, SurfaceEdge> entry) {
    ...
    public void release() {
        ...
        CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.processing.SurfaceProcessorNode$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m182xa4033323();
            }
        });
    }

    /* renamed from: lambda$release$2$androidx-camera-core-processing-SurfaceProcessorNode, reason: not valid java name */
    /* synthetic */ void m182xa4033323() {
