...
public final class LongSparseArrayKt {
    ...
    public static final class C00361<T> implements Iterator<T>, KMappedMarker {
        ...
        C00361(LongSparseArray<T> longSparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(LongSparseArray<T> longSparseArray) {
        return new C00361(longSparseArray);
    }
