...
public final class C0205SegmentedByteString extends ByteString {
    ...
    public C0205SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        C0205SegmentedByteString c0205SegmentedByteString = this;
        int iResolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0205SegmentedByteString, endIndex);
        if (!(beginIndex >= 0)) {
        ...
        if (beginIndex == 0 && iResolveDefaultParameter == size()) {
            return c0205SegmentedByteString;
        }
