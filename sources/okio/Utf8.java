        ...
        while (i < i2) {
            ...
            if (Intrinsics.compare((int) cCharAt, 128) < 0) {
                ...
                if (Intrinsics.compare((int) cCharAt, 2048) < 0) {
                    yield.invoke(Byte.valueOf((byte) ((cCharAt >> 6) | JfifUtil.MARKER_SOFn)));
