...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM1110constructorimpl2;
        ...
        try {
            ...
            objM1110constructorimpl = Result.m1110constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1110constructorimpl = Result.m1110constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m1113exceptionOrNullimpl(objM1110constructorimpl) == null) {
            obj2 = objM1110constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM1110constructorimpl2 = Result.m1110constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM1110constructorimpl2 = Result.m1110constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m1113exceptionOrNullimpl(objM1110constructorimpl2) == null) {
            obj = objM1110constructorimpl2;
        }
