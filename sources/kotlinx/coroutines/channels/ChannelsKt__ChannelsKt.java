...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM1110constructorimpl = Result.m1110constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM1110constructorimpl = Result.m1110constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m2624boximpl(Result.m1117isSuccessimpl(objM1110constructorimpl) ? ChannelResult.INSTANCE.m2639successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2637closedJP2dKIU(Result.m1113exceptionOrNullimpl(objM1110constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2614trySendJP2dKIU = sendChannel.mo2614trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m2634isSuccessimpl(sendChannel.mo2614trySendJP2dKIU(obj))) {
            return;
        }
