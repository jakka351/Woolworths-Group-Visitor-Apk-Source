...
public interface SendChannel<E> {
    ...
    Object mo2614trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2634isSuccessimpl(objMo2614trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2628exceptionOrNullimpl = ChannelResult.m2628exceptionOrNullimpl(objMo2614trySendJP2dKIU);
