...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2642trySendImplMj0NB7M = conflatedBufferedChannel.m2642trySendImplMj0NB7M(e, true);
        if (objM2642trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2628exceptionOrNullimpl(objM2642trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2642trySendImplMj0NB7M = conflatedBufferedChannel.m2642trySendImplMj0NB7M(e, true);
        if (!(objM2642trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2614trySendJP2dKIU(E element) {
        return m2642trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2642trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2640trySendDropLatestMj0NB7M(element, isSendOp) : m2641trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2640trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2614trySendJP2dKIU = super.mo2614trySendJP2dKIU(element);
        if (ChannelResult.m2634isSuccessimpl(objMo2614trySendJP2dKIU) || ChannelResult.m2632isClosedimpl(objMo2614trySendJP2dKIU)) {
            return objMo2614trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m2639successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m2641trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m2637closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2614trySendJP2dKIU = mo2614trySendJP2dKIU(element);
        if (!(objMo2614trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2614trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2628exceptionOrNullimpl(objMo2614trySendJP2dKIU);
