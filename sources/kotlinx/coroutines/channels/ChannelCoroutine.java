...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2618receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2618receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2619tryReceivePtdJZtk() {
        return this._channel.mo2619tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2614trySendJP2dKIU(E element) {
        return this._channel.mo2614trySendJP2dKIU(element);
    }
