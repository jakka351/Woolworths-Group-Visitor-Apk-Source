...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2670scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2601delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2602toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2602toDelayMillisLRDsOJo(long j) {
        if (Duration.m2435compareToLRDsOJo(j, Duration.INSTANCE.m2539getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2454getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
