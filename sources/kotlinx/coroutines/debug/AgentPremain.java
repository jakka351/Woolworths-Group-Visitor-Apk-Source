...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM1110constructorimpl = Result.m1110constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1110constructorimpl = Result.m1110constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m1116isFailureimpl(objM1110constructorimpl) ? null : objM1110constructorimpl);
