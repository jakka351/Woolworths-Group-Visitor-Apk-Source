...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        Object objM1110constructorimpl;
        try {
            ...
            objM1110constructorimpl = Result.m1110constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1110constructorimpl = Result.m1110constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m1116isFailureimpl(objM1110constructorimpl)) {
            objM1110constructorimpl = null;
        }
        return (Function1) objM1110constructorimpl;
    }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            DebugProbesImpl debugProbesImpl = this;
            objM1110constructorimpl = Result.m1110constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1110constructorimpl = Result.m1110constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) objM1110constructorimpl;
