...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM1113exceptionOrNullimpl = Result.m1113exceptionOrNullimpl(result);
        if (thM1113exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM1113exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;
