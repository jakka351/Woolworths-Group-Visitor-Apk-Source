...
final /* synthetic */ class FlowKt__CountKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__CountKt", f = "Count.kt", i = {0}, l = {17}, m = MetricSummary.JsonKeys.COUNT, n = {ContextChain.TAG_INFRA}, s = {"L$0"})
    ...
    /* compiled from: Count.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__CountKt", f = "Count.kt", i = {0}, l = {ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_HORIZONTAL_BIAS}, m = MetricSummary.JsonKeys.COUNT, n = {ContextChain.TAG_INFRA}, s = {"L$0"})
