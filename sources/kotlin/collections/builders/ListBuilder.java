...
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
    ...
    private final void insertAtInternal(int i, int n2) {
        ensureExtraCapacity(n2);
        E[] eArr = this.backing;
        ArraysKt.copyInto(eArr, eArr, i + n2, i, this.length);
        this.length += n2;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void addAllInternal(int i, Collection<? extends E> elements, int n2) {
        registerModification();
        insertAtInternal(i, n2);
    ...
    public static final class BuilderSubList<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
        ...
        private final void addAllInternal(int i, Collection<? extends E> elements, int n2) {
            registerModification();
            BuilderSubList<E> builderSubList = this.parent;
            if (builderSubList == null) {
                this.root.addAllInternal(i, elements, n2);
            } else {
                builderSubList.addAllInternal(i, elements, n2);
            }
            this.backing = (E[]) ((ListBuilder) this.root).backing;
            this.length += n2;
        }
