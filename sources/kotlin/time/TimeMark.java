...
public interface TimeMark {
    ...
    TimeMark mo2427minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo2429plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2574plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2573minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo2429plusLRDsOJo(Duration.m2489unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m2469isNegativeimpl(timeMark.mo2426elapsedNowUwyO8pc());
        }
