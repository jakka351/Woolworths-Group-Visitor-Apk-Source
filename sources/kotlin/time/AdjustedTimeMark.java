...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo2427minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2573minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo2426elapsedNowUwyO8pc() {
        return Duration.m2471minusLRDsOJo(this.mark.mo2426elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo2429plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2472plusLRDsOJo(this.adjustment, duration), null);
    }
}
