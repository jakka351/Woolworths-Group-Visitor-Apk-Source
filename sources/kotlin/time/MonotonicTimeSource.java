...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2576boximpl(m2570markNowz9LOYto());
    }
    ...
    public long m2570markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2579constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2569elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2568differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2567adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2579constructorimpl(LongSaturatedMathKt.m2565saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
