...
public final class UMathKt {
    ...
    private static final int m2323minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m2305minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m2324mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m2313minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m2321maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m2293maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m2322maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m2301maxOfeb3DHEI(j, j2);
    }
}
