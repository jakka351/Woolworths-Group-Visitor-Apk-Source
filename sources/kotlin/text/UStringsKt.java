...
public final class UStringsKt {
    ...
    public static final String m2423toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2425toStringolVBNx4(short s, int i) {
    ...
    public static final String m2424toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(i & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m2422toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m1205constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m1122boximpl(UByte.m1128constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m1205constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m1385boximpl(UShort.m1391constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM1205constructorimpl = UInt.m1205constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM1205constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM1205constructorimpl2 = UInt.m1205constructorimpl(i3 * iM1205constructorimpl);
            int iM1205constructorimpl3 = UInt.m1205constructorimpl(UInt.m1205constructorimpl(iDigitOf) + iM1205constructorimpl2);
            if (Integer.compareUnsigned(iM1205constructorimpl3, iM1205constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM1205constructorimpl3;
        }
        return UInt.m1199boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM1284constructorimpl = ULong.m1284constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM1284constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM1284constructorimpl2 = ULong.m1284constructorimpl(j * jM1284constructorimpl);
            long jM1284constructorimpl3 = ULong.m1284constructorimpl(ULong.m1284constructorimpl(UInt.m1205constructorimpl(r13) & 4294967295L) + jM1284constructorimpl2);
            if (Long.compareUnsigned(jM1284constructorimpl3, jM1284constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM1284constructorimpl3;
        }
        return ULong.m1278boximpl(j);
    }
}
