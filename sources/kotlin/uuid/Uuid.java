...
public final class Uuid implements Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m1278boximpl(ULong.m1284constructorimpl(getMostSignificantBits())), ULong.m1278boximpl(ULong.m1284constructorimpl(getLeastSignificantBits())));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m2599fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public static final int LEXICAL_ORDER$lambda$2(Uuid uuid, Uuid uuid2) {
        ...
        if (j != uuid2.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m1284constructorimpl(j), ULong.m1284constructorimpl(uuid2.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m1284constructorimpl(uuid.leastSignificantBits), ULong.m1284constructorimpl(uuid2.leastSignificantBits));
    }
}
